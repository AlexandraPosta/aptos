...
#define IMU_ACCEL_RANGE ICM20649_ACCEL_RANGE_30_G
#define IMU_GYRO_RANGE ICM20649_GYRO_RANGE_1000_DPS
#define NUM_GYRO_CALIB_READINGS 200
#define NUM_ACCEL_CALIB_READINGS 200
#define NUM_LAUNCH_ROD_ORIENT_READINGS 200

#define BMP_CS_PIN 24
...
namespace SensorInterface
{
    ...
    private:
        ...
        Euler currentOrientationEuler{0.0, 0.0, 0.0};
        Euler currentOrientationRateEuler{0.0, 0.0, 0.0};
        Euler prevOrientationEuler{0.0, 0.0, 0.0};
        GyroMeasurement gyroValues{0.0};
        GyroMeasurement gyroOffset{0.0, 0.0, 0.0};
        AccelMeasurement accelValues{0.0};
    ...
    public:
        ...
        void writeDebugToSerial(unsigned long dt);
        ...
        void setStateSpace(float stateSpace[STATE_SPACE_SIZE]);
        ...
        void getLastOrientationRate(float &w, float &x, float &y, float &z);
        bool detectLaunch();
        bool detectApogee();
        bool detectLanding();
