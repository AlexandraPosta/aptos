...
In order to run the Simulink file – Time_Varying_Model_2022a – ensure the following add-ons are installed: Aerospace Blockset v23.2, Aerospace Toolbox v23.2, Control System Toolbox v23.2, Simscape v23.2, Simscape Electrical v23.2 and Simulink v23.2.
To check what add-ons you have installed open Simulink and select the ‘Get Add-ons’ button located under the ‘APPS’ tab. In the new window that appears, select the ‘Manage Add-ons’ button found in the top right-hand corner. The Add-ons that are installed and active will appear here. If there are differences between your list and the list above, search for and install the missing Add-ons.
