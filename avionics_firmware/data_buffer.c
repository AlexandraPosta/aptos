...
float get_vertical_velocity(int data[], int previous_barometer, int new_barometer, int size, int dt) {
  ...
  for (int i = 1; i < size; ++i) {
      ...
      current_altitude = 44330.7692 * (1.0 - pow(((float)data[i] / 100.0f) / sea_level_pressure, 0.1902)); 
